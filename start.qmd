...
* have a look at the [MADSCode](https://marketplace.visualstudio.com/items?itemName=MADS-Net.madscode) plugin for VSCode, which provides tools for quickly prototyping plugins and launching broker and director instances
...
Finally, the **FMU agent** allows to quickly wrap [FMUs](https://fmi-standard.org/) in MADS agents, which can be used for prototyping and testing FMUs in a MADS environment.

:::{.callout-note title="Links"}
* [Python Agent](guides/python_agent.qmd)
* [Python interface](guides/python.qmd)
* [R plugin](guides/r_plugin.qmd)
* [FMU agent](guides/fmu.qmd)
