...
resources:
  - MADS_Animation/MADSNetworkEmbed.html
format:
  revealjs:
    ...
    qountdown:
      minutes: 45
      label: true      # optional remaining-time readout
      label-position: tl
revealjs-plugins: [tabset, qountdown]
abstract: |
...
| **ROS2** | flexible, high level, feature rich | long learning curve, robotics oriented, no fed'n | 🟢 | 🟢 | {{< lc curve=1 >}} |
| {{< logo >}} | **easy**, ZeroMQ-based, portable, flexible, polyglot, fed'n | young (3 years) | 🟢🟢 | 🟠🟢 | **{{< lc curve=0.5 >}}** |

:::callout-note
**Low-level**: framework only/mostly taking care of data communication/distribution, where business logic must be implemented every time; **portability**: different platforms/architectures; **integrability**: against existing solutions; **fed'n** means federation; learning curves {{< lc >}} are subjective and qualitative.
:::
:::
...
* Python script [FFI](https://en.wikipedia.org/wiki/Foreign_function_interface)-linked to the `MadsCore` library (`from mads_agent import Agent`)
...
* Plugin name: [ArduinoIO.plugin](https://github.com/MADS-NET/ArduinoIO_plugin)

:::

::: {.column width="33%"}

[<img class="opengraph-image" src="https://opengraph.githubassets.com/2.4.1/pbosetti/ArduinoDriver" alt="ArduinoDriver" width="450px" />](https://github.com/pbosetti/ArduinoDriver)

[<img class="opengraph-image" src="https://opengraph.githubassets.com/2.4.1/MADS-NET/ArduinoIO_plugin" alt="ArduinoDriver" width="450px" />](https://github.com/MADS-NET/ArduinoIO_plugin)
:::
...
:::center
![Rerun window (see <https://rerun.io>)](rerun.png){width=75%}
:::
...
::: {.column}
![NovaWalk robotic walker](./NovaWalk.jpg){width=100%}
:::
...
::: {.column}
![MirrorWorld PRIN 2022](./MirrorWorld.jpg){width=100%}
:::
...
* Full lesson exercise is [here](gorini_exercise.qmd){target="_blank"}, with source code on [GitHub](https://github.com/pbosetti/Gorini){target="github"}