...
* an agent that visualizes the data and the computed statistics in [Rerun](https://rerun.io){target="rerun"}
* an agent that logs the data and the computed statistics to a MongoDB database

:::aside

The code here presented is available on [GitHub](https://github.com/pbosetti/Gorini){target="github"}.
...
If the command `rerun` opens a GUI window, you are ready to go. If not, check the [Rerun installation guide](https://rerun.io/docs/getting-started){target="rerun"} for your platform.
...
Confguring the Rerun application is beyond the scope of this exercise, but you can find some examples in the [Rerun documentation](https://rerun.io/docs/concepts/visualization/blueprints){target="rerun"}.
