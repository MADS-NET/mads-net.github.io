...
**MADS v2.4.0** is OUT! This version introduces some **breaking changes**: look at [the changes here](https://github.com/pbosetti/MADS/blob/v2/CHANGES.md) to learn more.
:::
